...
import traceback  # Import the traceback module at the top of your file
...
app = Flask(__name__)
# Updated line for MySQL database connection
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:Tabook22@localhost/mydb'
...
class User(db.Model):
    ...
    password_hash = db.Column(db.String(255), nullable=False)  # Update this line
    ...
    if request.method == 'POST':
        ...
        if not error_messages:
            ...
            try:
                ...
                db.session.rollback()
                error_messages['database'] = f"An error occurred: {e}."
